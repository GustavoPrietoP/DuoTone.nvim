...
theme.set_highlights = function()
  ...
  hl(0, "Pmenu", { fg = c.base07, bg = c.base00 })
  ...
  hl(0, "CursorLineNr", { fg = c.base0G, bg = 'NONE' })
  ...
  hl(0, "Normal", { fg = c.base08, bg = c.base00 })
  ...
  hl(0, "Visual", { fg = c.blue, bg = c.lightbg,  })
  ...
  hl(0, "CursorLine", { fg = 'NONE', bg = c.white })
  ...
  hl(0, "GitAdd", { fg = c.base05, bg = c.base00 })
  hl(0, "GitDelete", { fg = c.red, bg = c.base00 })
  hl(0, "GitChange", { fg = c.orange, bg = c.base00 })
  hl(0, "GitSignsAdd", { fg = c.base00, bg = c.base00 })
  hl(0, "GitSignsChange", { fg = c.orange, bg = c.base00 })
  hl(0, "GitSignsDelete", { fg = c.red, bg = c.base00 })
  hl(0, "GitChange", { fg = c.orange, bg = c.base00 })
  hl(0, "GitChange", { fg = c.orange, bg = c.base00 })
  ...
  hl(0, "CmpItemAbbr", { fg = c.base08, bg = 'NONE' })
  hl(0, "CmpItemAbbrMatch", { fg = c.blue, bg = 'NONE', bold=true, })
  hl(0, "CmpItemMenu", { fg = c.lightbg, bg = 'NONE', bold=true, })
  hl(0, "CmpDocBorder", { fg = c.darker_black, bg = c.darker_black })
--  hl(0, "CmpPmenu", { fg = c.red, bg = c.green })
  --hl(0, "CmpSel", { fg = c. green, bg = c.red})
  ...
  hl(0, "NvimTreeEndOfBuffer", { fg = c.base0E, bg = 'NONE' })
  ...
  hl(0, "NvimTreeNormal", { fg = 'NONE', bg = c.base00,  })
  hl(0, "NvimTreeNormalNC", { fg = 'NONE', bg = c.base00 })
  hl(0, "NvimTreeOpenedFolderName", { fg = c.folder_bg, bg = 'NONE' })
  hl(0, "NvimTreeGitIgnored", { fg = c.light_grey, bg = 'NONE' })
  hl(0, "NvimTreeWinSeparator", { fg = c.base00, bg = c.base00 })
  ...
  hl(0, "Delimiter", { fg = c.base08, bg = 'NONE' })
  ...
  hl(0, "TelescopePromptPrefix", { fg = c.base05, bg = c.base00 })
  hl(0, "TelescopeNormal", { fg = 'NONE', bg = c.base00 })
  hl(0, "TelescopePreviewTitle", { fg = c.base00, bg = c.base05 })
  hl(0, "TelescopePromptTitle", { fg = c.base00, bg = c.base05 })
  hl(0, "TelescopeSelection", { fg = c.base06, bg = c.black2 })
  ...
  hl(0, "TelescopeResultsTitle", { fg = c.base00, bg = c.base05 })
  hl(0, "TelescopePromptNormal", { fg = 'NONE', bg = c.base00 })
  ...
  hl(0, "@function", { fg = c.base05, bg = 'NONE' })
  hl(0, "@function.builtin", { fg = c.base05, bg = 'NONE' })
  hl(0, "@function.macro", { fg = c.base08, bg = 'NONE' })
  hl(0, "@function.call", { fg = c.base0D, bg = 'NONE' })
  hl(0, "@operator", { fg = c.base05, bg = 'NONE' })
  hl(0, "@keyword.operator", { fg = c.base05, bg = 'NONE' })
  ...
  hl(0, "@variable", { fg = c.base08, bg = 'NONE' })
  ...
  hl(0, "@field", { fg = c.base05, bg = 'NONE' })
  ...
  hl(0, "WhichKeyDesc", { fg = c.base04, bg = 'NONE' })
  hl(0, "WhichKeyGroup", { fg = c.base05, bg = 'NONE' })
  hl(0, "WhichKeyValue", { fg = c.base05, bg = 'NONE' })
end
